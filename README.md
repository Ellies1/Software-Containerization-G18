...
nodeapp-deployment.yaml configured a load balancer named nodeapp-service which will select pods with frontend label to associate with. It listens on port 80 of the cluster IP and redirects the traffic to the port 3000 of the associated pods.
