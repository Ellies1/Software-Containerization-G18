...
### Load Balancer
values.yaml configured a load balancer named nodeapp which will select pods with frontend label to associate with. It listens on port 80 of the cluster IP and redirects the traffic to the port 3000 of the associated pods.
...
kubernetes              ClusterIP      10.48.0.1     <none>           443/TCP          5d1h
mongo-express-service   NodePort       10.48.5.106   <none>           8081:30010/TCP   7h26m
mongodb-service         ClusterIP      10.48.7.127   <none>           27017/TCP        7h26m
nodeapp-service         LoadBalancer   10.48.7.135   34.141.129.122   80:30011/TCP     7h26m
```
